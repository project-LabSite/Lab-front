const Footer = () => {
  return (
    <div className="fixed bottom-0 left-0 w-full flex flex-col sm:flex-row items-center text-gray-400 justify-around backdrop-blur-md bg-transparent p-4">
      <div className="py-2 text-center md:text-left hidden sm:block">
