...
const Main = () => {
    return (
        <div
            className="relative pt-28 w-full min-h-[calc(100vh-88px)] bg-cover bg-no-repeat bg-center"
            ...
            <div className="relative pt-28 pl-24 flex flex-col justify-center items-center text-gray-100">
                ...
                <div className="fade-in-section flex flex-col items-center mt-32">
                    <p className="text-lg max-w-2xl text-center">
                        Our mission is to innovate and lead in polymer research for a sustainable future. We focus on
                        developing advanced materials and technologies that address the world's energy and environmental
                        challenges. Through interdisciplinary collaboration and cutting-edge research, we aim to create
                        solutions that promote sustainability, efficiency, and resilience across various industries.
                    </p>
                    <a
