        ...
        <div className="w-full max-w-md border border-blue-200 rounded-lg p-8">
            <form className="flex flex-col space-y-4">
                ...
                <div className="flex items-center space-x-2">
                    <input id="remember_me" type="checkbox" className="h-4 w-4 text-blue-500 border-gray-100 rounded" />
            ...
            <div className="mt-4 flex justify-end text-sm text-gray-400">
                <div
                    to="/signup"
                    className="hover:underline after:content-['|'] after:mx-2 after:text-gray-300 cursor-pointer"
                    onClick={toggleForm}
                >
                    회원 가입
                </div>
